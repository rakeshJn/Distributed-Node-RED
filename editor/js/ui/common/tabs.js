    ...
    function createTabs(options) {
        ...
        function activateTab(link) {
            ...
            if (!link.parent().hasClass("active")) {
                ...
                wrapper.find(".red-ui-tab-fixed-button").removeClass("active");
                $("#"+parentId+"-fixed-button").addClass("active");
                if (options.scrollable) {
        ...
        return {
            addTab: function(tab) {
                ...
                if (tab.fixed) {
                    ...
                    var fixedLink = $('<a href="#'+tab.id+'" class="red-ui-tab-fixed-button"></a>').insertBefore(collapsedButtonsRow.find("a:last"));
                    fixedLink.attr('id',li.attr('id')+"-fixed-button");
                    if (tab.iconClass) {
